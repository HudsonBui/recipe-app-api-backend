...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_api(self):
        ...
        # Get recipe in db and check if it matches the payload
        # Match user and each attribute of model Recipe
    ...
    def test_delete_other_users_error(self):
        """Test trying to delete other users recipe fails."""
        new_user = create_user(
            email='user2@example.com',
            password='testpass123'
        )
    ...
    def test_create_recipe_with_existing_tag(self):
        """test_create_recipe_with_existing_tag"""
    ...
    def test_create_new_recipe_with_existing_ingredient(self):
        """Test creatign a recipe with existing ingredient."""
        ...
        payload = {
            ...
            'time_minutes': 20,
            'price': Decimal('2.5'),
            'ingredients': [{'name': 'Lentils'}, {'name': 'Curry powder'}],
        }
    ...
    def test_clear_recipe_ingredients(self):
        """Test clearing a recipe's incredients."""
        ingredient = Ingredient.objects.create(
            name='Garlic',
            user=self.user
        )
